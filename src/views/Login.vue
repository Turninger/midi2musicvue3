        ...
        <div class="u-align-left u-clearfix u-sheet u-sheet-1">
            <div class="u-container-style u-group u-radius-30 u-shape-round u-white u-group-1">
                <div class="u-container-layout u-container-layout-1" id="login">
                    ...
                    <a href="/register" class="u-active-none u-border-2 u-border-palette-1-base u-bottom-left-radius-0 u-bottom-right-radius-0 u-btn u-btn-rectangle u-button-style u-hover-none u-none u-radius-0 u-top-left-radius-0 u-top-right-radius-0 u-btn-2">没有账户？立即创建！</a>
                </div>
            </div>
            <div class="u-form u-login-control u-form-1">
<!--                拦截刷新，构造登录方法-->
                <form @click.prevent="login" action="#" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
                    <div class="u-form-group u-form-name">
                        <label for="username-a30d" class="u-label">Username *</label>
                        <input v-model="username" type="text" placeholder="手机号码/邮箱地址/用户名" id="username-a30d" name="username" class="u-border-grey-30 u-input u-input-rectangle u-input-1" required="">
                    </div>
                    <div class="u-form-group u-form-password">
                        <label for="password-a30d" class="u-label">Password *</label>
                        <input v-model="password" type="password" placeholder="登录密码" id="password-a30d" name="password" class="u-border-grey-30 u-input u-input-rectangle u-input-2" required="">
                    </div>
                    ...
                    <div class="u-align-left u-form-group u-form-submit">
                        <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-hover-grey-10 u-btn-3">登录</a>
    ...
    export default {
        ...
        methods:{
            login(){
                ...
                axios.post('http://localhost:8182/user/login').then((resp)=>{
                    console.log(resp)
